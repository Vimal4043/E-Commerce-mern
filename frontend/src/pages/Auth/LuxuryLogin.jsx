                ...
                >
                    ...
                    <div className="bg-dark-card/50 backdrop-blur-xl border border-dark-border rounded-3xl p-8 md:p-12 shadow-2xl">
                        ...
                        <motion.button
                            ...
                            whileHover={false}
                            whileTap={false}
                            className="w-full py-4 rounded-full border border-dark-border text-white opacity-50 cursor-not-allowed flex items-center justify-center gap-3 transition-all duration-300"
                        >
