                ...
                <div className="relative z-10 flex flex-col justify-center items-center p-12 text-center">
                    ...
                    >
                        ...
                        <p className="typo-body-sm text-text-secondary max-w-md mx-auto mb-8">
                            Become part of a distinguished community. Create your account and unlock access to exclusive timepieces.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                >
                    ...
                    <div className="bg-dark-card/50 backdrop-blur-xl border border-dark-border rounded-3xl p-8 md:p-12 shadow-2xl">
                        <div className="text-center mb-8">
                            <h1 className="typo-h2 text-white mb-2">Create Account</h1>
                            <p className="typo-body-sm text-text-muted">Start your luxury journey</p>
                        </div>
                        ...
                        {msg && (
                            <motion.div
                                ...
                                className={`mb-6 p-4 rounded-xl text-sm text-center ${msg.includes("successfully")
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="relative">
                                <label className="block text-xs text-text-muted mb-2 uppercase tracking-wider">Full Name</label>
                                <div className="relative">
                        ...
                        <motion.button
                            ...
                            whileTap={undefined}
                            className="w-full py-4 rounded-full border border-dark-border text-white opacity-50 cursor-not-allowed flex items-center justify-center gap-3 transition-all duration-300 disabled:pointer-events-auto"
                        >
