        ...
        <section ref={sectionRef} className="section-padding bg-dark">
            ...
            <div className="container-lux relative z-10">
                ...
                >
                    ...
                    <h2 className="typo-h1 text-white mb-6">Client Reviews</h2>
                ...
                <div className="relative">
                    <div className="flex gap-6 overflow-x-auto pb-8 hide-scrollbar snap-x snap-mandatory">
                        {reviews.map((review, index) => (
                            ...
                            >
                        <div className="h-full bg-dark-card border border-dark-border rounded-2xl p-8 card-hover relative group">
                            {/* Quote Mark */}
                            ...
                            {/* Review Text */}
                            <p className="typo-quote text-text-secondary mb-10 leading-relaxed">
                                "{review.text}"
                            </p>
